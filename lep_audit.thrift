...
struct AuditInfo {
    1: i64 id
    2: i32 audit_type // 1-物料审核，2-需求审核
    3: i32 target_id // 审核目标id
    4: i32 target_type // 审核目标类型 // 1-文字，2-图片，3-视频，4-文件
    5: string apply_info // 附加申请信息
    6: i32 audit_status // 审核状态：1-待审核，2-审核通过，3-审核驳回
    7: i64 apply_user_id // 申请人user_id
    8: i64 auditor_user_id // 审核人user_id
    9: string auditor_user_name // 审核人
